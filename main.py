...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # upsample by 2 times
    layer_7_up = tf.layers.conv2d_transpose(conv_1x1_layer7, num_classes,4, strides=(2, 2), padding='same',
                                            kernel_initializer=tf.random_normal_initializer(stddev=weights_initializer_stddev),
                                            kernel_regularizer=tf.contrib.layers.l2_regularizer(weights_regularized_l2))
    ...
    conv_1x1_layer4 = tf.layers.conv2d(vgg_layer4_out, num_classes, 1, padding ='same',
                                       ...
                                       kernel_regularizer= tf.contrib.layers.l2_regularizer(weights_regularized_l2))
    # Adding skip layer.
    first_skip_layer = tf.add(layer_7_up, conv_1x1_layer4)
    
    # Upsample by 2 times
    layer_4_up = tf.layers.conv2d_transpose(first_skip_layer, num_classes, 4, strides=(2, 2), padding='same',
                                            kernel_initializer=tf.random_normal_initializer(stddev=weights_initializer_stddev),
                                            kernel_regularizer=tf.contrib.layers.l2_regularizer(weights_regularized_l2))
    ...
    conv_1x1_layer3 = tf.layers.conv2d(vgg_layer3_out, num_classes, 1, padding='same',
                                       ...
                                       kernel_regularizer=tf.contrib.layers.l2_regularizer(weights_regularized_l2))
    # Adding skip layer.
    second_skip_layer = tf.add(layer_4_up, conv_1x1_layer3)
    # Upsample deconvolution x 8.
    layer_3_up = tf.layers.conv2d_transpose(second_skip_layer, num_classes,16, strides=(8, 8), padding='same',
                                            kernel_initializer=tf.random_normal_initializer(stddev=weights_initializer_stddev),
                                            kernel_regularizer=tf.contrib.layers.l2_regularizer(weights_regularized_l2))
    return layer_3_up
